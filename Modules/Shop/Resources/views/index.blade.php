...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(modules/shop/images/slide-01.jpg);">
				...
				<div class="item-slick1" style="background-image: url(modules/shop/images/slide-02.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url(modules/shop/images/slide-03.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
			...
			<div class="row">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="{{asset('images/' . $category->image->name)}}" style="width:255px; height:315px;" alt="IMG-BANNER">
						...
						<a href="product.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								...
								<span class="block1-info stext-102 trans-04">
									{{__('views.shop.spring_2018')}}
								</span>
							</div>

							<div class="block1-txt-child2 p-b-4 trans-05">
								<div class="block1-link stext-101 cl0 trans-09">
									{{__('views.shop.shop_now')}}
								</div>
							</div>
						</a>
					</div>
		...
		<div class="container">
			<div class="p-b-10 text-center">
				<h3 class="ltext-103 cl5">
					{{ __('views.shop.products_general') }}
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$product->category->name}}">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="{{asset('images/' . $product->images()->first()->name)}}" style="width:255px; height:315px;" alt="{{$product->slug}}">
